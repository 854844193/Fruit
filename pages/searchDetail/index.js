...
Page({
  ...
  toggle(e) {
    ...
    self.setData({
      isActive: params.ind,
      currentInd: params.ind
    })
    this.getshopBycd(params)

  },
  getshopBycd(c) {
    let cArr = this.data.conditonList
    console.log("------根据条件获取" + "~" + cArr[c.ind] + "~" + "水果-------")
  },
  toSearch() {
    wx.navigateBack()
  },
